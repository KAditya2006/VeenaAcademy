...
export async function loginAdmin(email, password, rememberMe, req) {
...
export async function refreshAdminSession(refreshToken, req) {
...
export async function logoutAdmin(refreshToken, req) {
    if (refreshToken) {
...
export async function changeAdminPassword(user, currentPassword, newPassword, req) {
